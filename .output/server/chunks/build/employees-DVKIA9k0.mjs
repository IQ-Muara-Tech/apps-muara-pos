      ...
      if (unref(loading)) {
        ...
        if (unref(filtered).length === 0) {
          ...
          ssrRenderList(unref(filtered), (emp) => {
            var _a, _b, _c, _d;
            _push(`<div class="bg-white rounded-xl border border-gray-100 p-4 hover:border-primary-300 hover:shadow-md cursor-pointer transition-all active:scale-[0.98]"><div class="flex items-center gap-3"><div class="w-10 h-10 bg-amber-50 rounded-full flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg></div><div class="flex-1 min-w-0"><p class="font-medium text-gray-900 text-sm">${ssrInterpolate(emp.name)}</p><p class="text-[11px] text-gray-400">${ssrInterpolate(((_b = (_a = emp.user) == null ? void 0 : _a.role) == null ? void 0 : _b.name) || emp.position)} \xB7 @${ssrInterpolate((_c = emp.user) == null ? void 0 : _c.username)}</p>`);
            if ((_d = emp.branches) == null ? void 0 : _d.length) {
...
//# sourceMappingURL=employees-DVKIA9k0.mjs.map
