...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex items-center justify-between mb-4"><h2 class="text-lg font-bold text-gray-900">Kategori</h2><button class="bg-primary-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-primary-700 active:scale-95 transition-all">+ Tambah</button></div><div class="mb-4">`);
      ...
      _push(ssrRenderComponent(_component_FormModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b;
          if (_push2) {
            _push2(`<div class="space-y-4"${_scopeId}><p class="text-sm text-gray-600"${_scopeId}>Yakin ingin menghapus <strong${_scopeId}>${ssrInterpolate((_a2 = unref(deleting)) == null ? void 0 : _a2.name)}</strong>?</p><div class="flex gap-3"${_scopeId}><button class="flex-1 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors"${_scopeId}>Batal</button><button class="flex-1 bg-red-500 text-white py-2.5 rounded-xl text-sm font-medium hover:bg-red-600 active:scale-95 transition-all"${_scopeId}>Hapus</button></div></div>`);
          } else {
            return [
...
//# sourceMappingURL=categories-DUcFqEz-.mjs.map
