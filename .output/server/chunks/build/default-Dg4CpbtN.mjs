...
import { ref, defineComponent, watchEffect, mergeProps, unref, h, computed, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderClass } from 'vue/server-renderer';
import { u as useAuthStore, n as navigateTo, b as useRoute } from './server.mjs';
import { _ as _sfc_main$4 } from './LoadingSpinner-CNrIgl7t.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isInstalled)) {
        _push(`<button class="mx-3 mb-2 py-2 bg-primary-600 text-white rounded-lg text-sm font-medium hover:bg-primary-700 active:scale-95 transition-all flex items-center justify-center gap-2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg><span>Install Aplikasi</span></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 font-bold text-sm"${_scopeId}>${ssrInterpolate((_b = (_a = unref(auth).user) == null ? void 0 : _a.name) == null ? void 0 : _b.charAt(0))}</div><div class="flex-1 min-w-0"${_scopeId}><p class="text-sm font-medium text-gray-900 truncate"${_scopeId}>${ssrInterpolate((_c = unref(auth).user) == null ? void 0 : _c.name)}</p><p class="text-xs text-gray-500"${_scopeId}>${ssrInterpolate((_e = (_d = unref(auth).user) == null ? void 0 : _d.role) == null ? void 0 : _e.name)}</p></div>`);
          } else {
            return [
              createVNode("div", { class: "w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 font-bold text-sm" }, toDisplayString((_g = (_f = unref(auth).user) == null ? void 0 : _f.name) == null ? void 0 : _g.charAt(0)), 1),
              createVNode("div", { class: "flex-1 min-w-0" }, [
                createVNode("p", { class: "text-sm font-medium text-gray-900 truncate" }, toDisplayString((_h = unref(auth).user) == null ? void 0 : _h.name), 1),
                createVNode("p", { class: "text-xs text-gray-500" }, toDisplayString((_j = (_i = unref(auth).user) == null ? void 0 : _i.role) == null ? void 0 : _j.name), 1)
              ])
            ];
          }
        }),
...
//# sourceMappingURL=default-Dg4CpbtN.mjs.map
