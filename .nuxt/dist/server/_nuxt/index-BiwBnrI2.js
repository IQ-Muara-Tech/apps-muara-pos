...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="mb-4"><h1 class="text-lg font-bold text-gray-900">Halo, ${ssrInterpolate(unref(auth).user?.name || "User")}</h1><p class="text-sm text-gray-500">${ssrInterpolate(unref(auth).user?.role?.name)}</p></div><div class="mb-4">`);
...
//# sourceMappingURL=index-BiwBnrI2.js.map
