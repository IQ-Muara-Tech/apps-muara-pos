...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-ae7725eb><div class="bg-gradient-to-b from-primary-600 to-primary-700 -mx-4 -mt-4 px-4 pt-6 pb-8 mb-6 rounded-b-3xl" data-v-ae7725eb><div class="flex flex-col items-center" data-v-ae7725eb><div class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-3 ring-4 ring-white/30" data-v-ae7725eb><svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ae7725eb><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-v-ae7725eb></path></svg></div><h2 class="text-lg font-bold text-white" data-v-ae7725eb>${ssrInterpolate(unref(auth).user?.name || "-")}</h2><p class="text-sm text-primary-200" data-v-ae7725eb>@${ssrInterpolate(unref(auth).user?.username || "-")}</p><span class="mt-2 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-xs font-medium text-white" data-v-ae7725eb>${ssrInterpolate(unref(auth).user?.role?.name || "-")}</span></div></div><div class="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100 mb-6" data-v-ae7725eb><div class="flex items-center gap-3 p-4" data-v-ae7725eb><div class="w-10 h-10 bg-amber-50 rounded-xl flex items-center justify-center flex-shrink-0" data-v-ae7725eb><svg class="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ae7725eb><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-v-ae7725eb></path></svg></div><div class="flex-1" data-v-ae7725eb><p class="text-xs text-gray-500" data-v-ae7725eb>Username</p><p class="text-sm font-medium text-gray-900" data-v-ae7725eb>${ssrInterpolate(unref(auth).user?.username || "-")}</p></div></div><div class="flex items-center gap-3 p-4" data-v-ae7725eb><div class="w-10 h-10 bg-green-50 rounded-xl flex items-center justify-center flex-shrink-0" data-v-ae7725eb><svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ae7725eb><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" data-v-ae7725eb></path></svg></div><div class="flex-1" data-v-ae7725eb><p class="text-xs text-gray-500" data-v-ae7725eb>Role</p><p class="text-sm font-medium text-gray-900" data-v-ae7725eb>${ssrInterpolate(unref(auth).user?.role?.name || "-")}</p></div></div><div class="p-4" data-v-ae7725eb><div class="flex items-center gap-3 mb-2" data-v-ae7725eb><div class="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0" data-v-ae7725eb><svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ae7725eb><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" data-v-ae7725eb></path></svg></div><div class="flex-1" data-v-ae7725eb><p class="text-xs text-gray-500" data-v-ae7725eb>Cabang</p></div></div>`);
...
//# sourceMappingURL=profile-BtXlXmPS.js.map
