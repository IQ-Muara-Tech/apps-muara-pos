...
import { $fetch as $fetch$1 } from "/Users/itmzt002/Documents/Projects/POS/frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/itmzt002/Documents/Projects/POS/frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/itmzt002/Documents/Projects/POS/frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/itmzt002/Documents/Projects/POS/frontend/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia, defineStore } from "pinia";
import { defu } from "/Users/itmzt002/Documents/Projects/POS/frontend/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/Users/itmzt002/Documents/Projects/POS/frontend/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BiwBnrI2.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-Dfhn3_oT.js")
  },
  {
    name: "sales",
    path: "/sales",
    component: () => import("./_nuxt/sales-CybYn-lG.js")
  },
  {
    name: "profile",
    path: "/profile",
  ...
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import("./_nuxt/reports-CPUY-LsZ.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-C72C5F2X.js")
  },
  {
    name: "employees",
    path: "/employees",
    component: () => import("./_nuxt/employees-DVKIA9k0.js")
  },
  {
    name: "categories",
    path: "/categories",
  ...
  },
  {
    name: "expenditures",
    path: "/expenditures",
    component: () => import("./_nuxt/expenditures-BxGH-h5C.js")
  },
  {
    name: "sale-process",
    path: "/sale-process",
    component: () => import("./_nuxt/sale-process-lpc2AvE2.js")
  },
  {
    name: "raw-materials",
    path: "/raw-materials",
    component: () => import("./_nuxt/raw-materials-DS-zO_LM.js")
  },
  {
    name: "select-branch",
    path: "/select-branch",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/select-branch-D1-YSLQN.js")
  },
  {
    name: "raw-material-stocks",
    path: "/raw-material-stocks",
    component: () => import("./_nuxt/raw-material-stocks-CvEcIPtR.js")
  },
  {
    name: "expenditure-categories",
    path: "/expenditure-categories",
    component: () => import("./_nuxt/expenditure-categories-BLCXVi2T.js")
  }
];
...
function useApi() {
  ...
  const baseURL2 = config.public.apiBase;
  ...
  async function get(url, params) {
    const qs = params ? "?" + new URLSearchParams(
      Object.entries(params).filter(([_, v]) => v !== void 0 && v !== "").map(([k, v]) => [k, String(v)])
    ).toString() : "";
    return api(`${url}${qs}`);
  }
  ...
  return { get, post, put, del, baseURL: baseURL2 };
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bo4EyjQN.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BKNSbvBp.js"));
